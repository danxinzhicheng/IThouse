...
public class HotPostFragment extends RefreshRecyclerFragment<List<CommunityListItem>, GetCommunityListEvent> {
    private String type;
    private String cid;
    ...
    public void initData(HeaderFooterAdapter adapter) {
        ...
        type = CommunityCategoryListActivity.TYPE_HOTPOST;
