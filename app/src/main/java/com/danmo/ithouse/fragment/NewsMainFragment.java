    ...
    protected void initViews(ViewHolder holder, View root) {
        ...
        pickerViewLayout.setOnTabPickingListener(new TabPickerView.OnTabPickingListener() {
            ...
            public void onRestore(List<SubTab> activeTabs) {
                SharedPreferencesHelper.putObject(DanmoApplication.sAppContext, "TabPickerActiveData", activeTabs);
            }
        });
        ...
        if (mTabPickerDataManager == null) {
            mTabPickerDataManager = new TabPickerView.TabPickerDataManager() {
                ...
                public List<SubTab> setupActiveDataSet() {
                    ...
                    Object obj = SharedPreferencesHelper.getObject(DanmoApplication.sAppContext,"TabPickerActiveData");
                    ...
                    if (list == null || list.size() <= 0) {
                        ...
                        SharedPreferencesHelper.putObject(DanmoApplication.sAppContext, "TabPickerActiveData", list);
                    }
                    return list;
                }
                ...
                public List<SubTab> setupOriginalDataSet() {
                    ...
                    Object obj = SharedPreferencesHelper.getObject(DanmoApplication.sAppContext,"TabPickerOriginalData");
                    List<SubTab> list = (List<SubTab>)obj;
                    if (list == null || list.size() <= 0) {
                        list = new ArrayList<>();
                        ...
                        SharedPreferencesHelper.putObject(DanmoApplication.sAppContext, "TabPickerOriginalData", list);
                    }
                    return list;
                }
                ...
                public void restoreActiveDataSet(List<SubTab> mActiveDataSet) {
                    SharedPreferencesHelper.putObject(DanmoApplication.sAppContext, "TabPickerActiveData", mActiveDataSet);
                }
            };
        }
