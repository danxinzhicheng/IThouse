...
public class QuanziListProvider extends BaseViewProvider<QuanziListItem> {
    public QuanziListProvider(@NonNull Context context) {
        super(context, R.layout.item_quanzi_list);
    }

    @Override
    public void onBindView(RecyclerViewHolder holder, QuanziListItem item) {
